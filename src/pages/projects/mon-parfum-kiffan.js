  ...
  return (
    <>
      <Head>
        ...
        ></link>
        <title>
          Mon Parfum Kiffan - E-commerce Website Development
        </title>
        <meta
          name="description"
          content="Mon Parfum Kiffan - E-commerce Website Development"
        />
      </Head>
...
I developed Mon Parfum Kiffan, a modern WordPress eCommerce website for an Algerian perfume brand. It features a clean design, product catalog, secure checkout, and responsive layout optimized for user experience and online sales.
              </h4>
            ...
            md:p-2 md:px-4 md:text-base"
                  ...
                  href="https://monparfum-kiffan.com"
                  target={"_blank"}
                >
                  Visit Demo
                </Link>
